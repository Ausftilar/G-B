                        ...
                        <div className="col-md-6">
                            <form >
                                <div className="mb-3">
                                    ...
                                    <input name="name" type="text" className="form-control" id="exampleForm" placeholder="John Smith" />
                                </div>
                                <div className="mb-3">
                                ...
                                <div className="mb-3">
                                    ...
                                    <textarea name="comment" className="form-control" id="exampleFormControlTextarea1" rows="5"></textarea>
                                </div>
